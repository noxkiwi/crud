    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <div class="title"><?= Translator::get('DELETEALL.CONFIRM') ?></div>
            </div>
            <div class="box-content padded">
                <div class="alert alert-warning alert-dismissible" role="alert">
                    <?= Translator::get('DELETEALL.REALLY') ?>
                    <br/><i><?= Translator::get('DELETEALL.INHERITANCE') ?></i>
                </div>
